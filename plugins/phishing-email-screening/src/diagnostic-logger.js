...
export function createDiagnosticLogger({
  level = process.env.PHISHING_MCP_LOG_LEVEL || "info",
  format = process.env.PHISHING_MCP_LOG_FORMAT || "text",
  timeZone = process.env.PHISHING_MCP_LOG_TIME_ZONE || "Asia/Shanghai",
